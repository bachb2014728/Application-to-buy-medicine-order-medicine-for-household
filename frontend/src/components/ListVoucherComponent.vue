<template>
  <div class="row justify-content-start" v-if="listItems && listItems.length">
      ...
      <div class="card mb-3 position-relative">
        ...
        <div class="position-absolute top-0 end-0 translate-middle-y" style="right: -50%;">
          <button type="button" class="btn btn-primary btn-sm me-2"
                  data-bs-toggle="modal" data-bs-target="#customModal" @click="selectedItem = item">
            Cập nhật
          </button>
          <button @click="confirmDelete(item)" class="btn btn-sm btn-danger text-light me-2">Xóa</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade" id="customModal" tabindex="-1" aria-hidden="true" style="display: none;" >
